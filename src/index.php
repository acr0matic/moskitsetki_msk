  ...
  <main>
    <section id="promo">
      <div class="container">
        <div class="wrapper">
          <div class="content">
            <h1 class="title">Изготовление москитных сеток и рулонных штор на заказ</h1>
            <ul class="advantages">
              <li class="advantages-item">Выезд специалиста бесплатно в день обращения;</li>
              <li class="advantages-item">Сетка по вашим размерам за 10 минут;</li>
              <li class="advantages-item">Даем гарантию 1 год с момента установки;</li>
              <li class="advantages-item">Свое производство, низкие цены;</li>
            </ul>
            <div class="wrap">
              <button data-anchor-button="#catalog" class="button button-large">Подробнее</button>
              <div class="social">
              ...
              <div class="swiper-wrapper">
                ...
                <div class="swiper-slide kit">
                  ...
                  <div class="kit-wrapper">
                    ...
                    <!-- /.kit-content -->
                    <button onclick="window.open('dust.html', '_self')"
                      class="button button-kit button-center">Подробнее</button>
                  </div>
                  <!-- /.kit-wrapper -->
                </div>
                <!-- /.kit -->
                ...
                <div class="swiper-slide kit">
                  ...
                  <div class="kit-wrapper">
                    ...
                    <!-- /.kit-content -->
                    <button onclick="window.open('zebra-box.html', '_self')"
                      class="button button-kit button-center">Подробнее</button>
                  </div>
                  <!-- /.kit-wrapper -->
                </div>
                ...
                <div class="swiper-slide kit">
                  ...
                  <div class="kit-wrapper">
                    ...
                    <!-- /.kit-content -->
                    <button onclick="window.open('mosquito.html', '_self')"
                      class="button button-kit button-center">Подробнее</button>
                  </div>
                  <!-- /.kit-wrapper -->
                </div>
    ...
    <section id="callback">
      <div class="container">
        ...
        <form data-form-type="no-modal" id="callback-index-form" class="form form-callback" action="mail.php"
    ...
    <section id="feedback">
      <div class="slider">
              ...
              <div class="swiper-slide feedback-card">
                ...
                <div class="feedback-text">
                  ...
                  <div class="feedback-info">
                    ...
                    <a href="https://www.instagram.com/belozoralena/" target="_blank" class="social-link"><img
              ...
              <div class="swiper-slide feedback-card">
                ...
                <div class="feedback-text">
                  ...
                  <div class="feedback-info">
                    ...
                    <a href="https://www.instagram.com/izuminka.msk/" class="social-link"><img class="social-icon"
                        src="img/icons/instagram.svg" alt=""></a>
        ...
        <button onclick="window.open('https://vk.com/moskitsetki_msk?z=album-179924034_263108745',  '_blank')"
          class="button button-center">Больше отзывов</button>
      </div>
      <!-- /.slider -->
    </section>
  </main>
