...
<main>
  <div class="container">
    <div class="section-title">
      <h1 class="sub-heading product-heading">Жалюзи (горизонтальные)</h1>
    </div>
    <!-- /.section-title -->
    <img class="product-page-image" src="<?php $_SERVER['DOCUMENT_ROOT'] ?>/img/catalog/items/jalousie-horizontal/promo.jpg" alt="">
  </div>
  <!-- /.container -->
  ...
  <section id="product-gallery">
    <div class="container">
      ...
      <div id="lightgallery" class="gallery">
        ...
        <a class="gallery-item gallery-item-large" data-fslightbox href="<?php $_SERVER['DOCUMENT_ROOT'] ?>/img/catalog/items/jalousie-horizontal/1.jpg">
          <img class="gallery-item-image" src="<?php $_SERVER['DOCUMENT_ROOT'] ?>/img/catalog/items/jalousie-horizontal/1.jpg" alt="">
        </a>
        <!-- /.gallery-item -->

        <a class="gallery-item gallery-item-large" data-fslightbox href="<?php $_SERVER['DOCUMENT_ROOT'] ?>/img/catalog/items/jalousie-horizontal/2.jpg">
          <img class="gallery-item-image" src="<?php $_SERVER['DOCUMENT_ROOT'] ?>/img/catalog/items/jalousie-horizontal/2.jpg" alt="">
        </a>
        <!-- /.gallery-item -->

        <a class="gallery-item" data-fslightbox href="<?php $_SERVER['DOCUMENT_ROOT'] ?>/img/catalog/items/jalousie-horizontal/3.jpg">
          <img class="gallery-item-image" src="<?php $_SERVER['DOCUMENT_ROOT'] ?>/img/catalog/items/jalousie-horizontal/3.jpg" alt="">
        </a>
        <!-- /.gallery-item -->

        <a class="gallery-item" data-fslightbox href="<?php $_SERVER['DOCUMENT_ROOT'] ?>/img/catalog/items/jalousie-horizontal/4.jpg">
          <img class="gallery-item-image" src="<?php $_SERVER['DOCUMENT_ROOT'] ?>/img/catalog/items/jalousie-horizontal/4.jpg" alt="">
        </a>
        <!-- /.gallery-item -->

        <a class="gallery-item" data-fslightbox href="<?php $_SERVER['DOCUMENT_ROOT'] ?>/img/catalog/items/jalousie-horizontal/5.jpg">
          <img class="gallery-item-image" src="<?php $_SERVER['DOCUMENT_ROOT'] ?>/img/catalog/items/jalousie-horizontal/5.jpg" alt="">
        </a>
        <!-- /.gallery-item -->
      </div>
      <!-- /.gallery -->
  ...
  <section id="calculation" data-product="jalousieHorizontal" data-calculator-type="curtains">
    <div class="container">
      <div class="section-title">
      ...
      <form class="calculator">
        <h3 class="calculator-title">Жалюзи (вертикальные)</h3>
            ...
            <div class="swiper-slide">
              <div class="calculator-column">
                ...
                <table>
                  ...
                  <tr>
                    <td id="item-name" class="cell-important">Тип жалюзи</td>
                    <td colspan="2" id="item-type" class="cell-important">Вертикальные</td>
                  </tr>
                </table>
