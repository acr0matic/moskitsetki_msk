 <?php
  // Мета-теги
  $title = "Рулонные шторы (свободновисящие)";
  $description = "";
  $keywords = "";
 ...
 <main>
   <div class="container">
     <div class="section-title">
       <h1 class="sub-heading product-heading">Рулонные шторы (свободновисящие)</h1>
     </div>
     <!-- /.section-title -->
     <img class="product-page-image" src="<?php $_SERVER['DOCUMENT_ROOT'] ?>/img/catalog/items/roller-blinds/promo.jpg" alt="">
   </div>
   <!-- /.container -->
   ...
   <section id="product-gallery">
     <div class="container">
       ...
       <div id="lightgallery" class="gallery">
         <a class="gallery-item gallery-item-large" data-fslightbox href="<?php $_SERVER['DOCUMENT_ROOT'] ?>/img/catalog/items/roller-blinds/1.jpg">
           <img class="gallery-item-image" src="<?php $_SERVER['DOCUMENT_ROOT'] ?>/img/catalog/items/roller-blinds/1.jpg" alt="">
         </a>
         <!-- /.gallery-item -->

         <a class="gallery-item gallery-item-large" data-fslightbox href="<?php $_SERVER['DOCUMENT_ROOT'] ?>/img/catalog/items/roller-blinds/2.jpg">
           <img class="gallery-item-image" src="<?php $_SERVER['DOCUMENT_ROOT'] ?>/img/catalog/items/roller-blinds/2.jpg" alt="">
         </a>
         <!-- /.gallery-item -->

         <a class="gallery-item" data-fslightbox href="<?php $_SERVER['DOCUMENT_ROOT'] ?>/img/catalog/items/roller-blinds/3.jpg">
           <img class="gallery-item-image" src="<?php $_SERVER['DOCUMENT_ROOT'] ?>/img/catalog/items/roller-blinds/3.jpg" alt="">
         </a>
         <!-- /.gallery-item -->

         <a class="gallery-item" data-fslightbox href="<?php $_SERVER['DOCUMENT_ROOT'] ?>/img/catalog/items/roller-blinds/4.jpg">
           <img class="gallery-item-image" src="<?php $_SERVER['DOCUMENT_ROOT'] ?>/img/catalog/items/roller-blinds/4.jpg" alt="">
         </a>
         <!-- /.gallery-item -->

         <a class="gallery-item" data-fslightbox href="<?php $_SERVER['DOCUMENT_ROOT'] ?>/img/catalog/items/roller-blinds/5.jpg">
           <img class="gallery-item-image" src="<?php $_SERVER['DOCUMENT_ROOT'] ?>/img/catalog/items/roller-blinds/5.jpg" alt="">
         </a>
         <!-- /.gallery-item -->
   ...
   <section id="calculation" data-product="rollerBlinds" data-calculator-type="curtains" data-calculator-method="width">
     <div class="container">
       <div class="section-title">
               ...
               <div class="calculator-column">
                 ...
                 <div class="calculator-block calculator-inputs input-wrapper">
                   <label class="input-label">
                     ...
                     <input min="0" id="calculator-height" class="input input-text input-shadow" type="number" placeholder="Например, 200см">
                   </label>
                   <label class="input-label">
                     <span class="input-info">ширина</span>
                     <input min="0" id="calculator-width" class="input input-text input-shadow" type="number" placeholder="Например, 100см">
                   </label>
                 </div>
                 <!-- /.input-wrapper -->
               ...
               <div class="calculator-column">
                 ...
                 <table>
                   ...
                   <tr>
                     ...
                     <td colspan="2" id="item-type" class="cell-important">Свободновисящая</td>
                   </tr>
                 </table>
