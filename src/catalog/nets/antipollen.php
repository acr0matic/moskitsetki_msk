<?php
// Мета-теги
$title = '"Москитная сетка "Антипыльца"';
$description = "";
$keywords = "";
...
<main>
  <div class="container">
    <div class="section-title">
      <h1 class="sub-heading product-heading">Москитная сетка "Антипыльца"</h1>
    </div>
    <!-- /.section-title -->
    <img class="product-page-image" src="<?php $_SERVER['DOCUMENT_ROOT'] ?>/img/catalog/items/anti-pollen/promo.jpg" alt="">
  </div>
  <!-- /.container -->
  ...
  <section id="product-description">
    <div class="container">
      ...
      <!-- /.section-title -->
      <p class="product-description">Сегодня многие люди страдают аллергией, и особенно ярко это заболевание выражается весной или летом, когда пыльца от цветущих растений витает в воздухе и проникает в квартиру через открытые для проветривания окна. Чтобы максимально обезопасить
        свое жилище, производители предлагают современную защиту для ваших окон - москитную сетку антипыльца (антипыль) Poll-tex производства Нидерландов. Благодаря этой сетчатой конструкции, в квартиру с улицы не проникнет не только пыль, но и мельчайшие
        частицы пыльцы, позволяя аллергикам спокойно проветривать комнату, не беспокоясь о собственном здоровье и хорошем самочувствии.
      </p>
    </div>
    <!-- /.container -->
  </section>
  ...
  <section id="calculation" data-product="antiPollen" data-calculator-type="mosquito-nets">
    <div class="container">
      <div class="section-title">
