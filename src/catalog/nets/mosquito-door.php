...
<main>
  <div class="container">
    <div class="section-title">
      <h1 class="sub-heading product-heading">Москитная дверь</h1>
    </div>
    <!-- /.section-title -->
    <img class="product-page-image" src="<?php $_SERVER['DOCUMENT_ROOT'] ?>/img/catalog/items/mosquito-door/promo.jpg" alt="">
  </div>
  <!-- /.container -->
  ...
  <section id="product-gallery">
    <div class="container">
      ...
      <div id="lightgallery" class="gallery">
        <a class="gallery-item gallery-item-large" data-fslightbox href="<?php $_SERVER['DOCUMENT_ROOT'] ?>/img/catalog/items/mosquito-door/1.jpg">
          <img class="gallery-item-image" src="<?php $_SERVER['DOCUMENT_ROOT'] ?>/img/catalog/items/mosquito-door/1.jpg" alt="">
        </a>
        <!-- /.gallery-item -->

        <a class="gallery-item gallery-item-large" data-fslightbox href="<?php $_SERVER['DOCUMENT_ROOT'] ?>/img/catalog/items/mosquito-door/2.jpg">
          <img class="gallery-item-image" src="<?php $_SERVER['DOCUMENT_ROOT'] ?>/img/catalog/items/mosquito-door/2.jpg" alt="">
        </a>
        <!-- /.gallery-item -->

        <a class="gallery-item" data-fslightbox href="<?php $_SERVER['DOCUMENT_ROOT'] ?>/img/catalog/items/mosquito-door/3.jpg">
          <img class="gallery-item-image" src="<?php $_SERVER['DOCUMENT_ROOT'] ?>/img/catalog/items/mosquito-door/3.jpg" alt="">
        </a>
        <!-- /.gallery-item -->

        <a class="gallery-item" data-fslightbox href="<?php $_SERVER['DOCUMENT_ROOT'] ?>/img/catalog/items/mosquito-door/4.jpg">
          <img class="gallery-item-image" src="<?php $_SERVER['DOCUMENT_ROOT'] ?>/img/catalog/items/mosquito-door/4.jpg" alt="">
        </a>
        <!-- /.gallery-item -->

        <a class="gallery-item " data-fslightbox href="<?php $_SERVER['DOCUMENT_ROOT'] ?>/img/catalog/items/mosquito-door/5.jpg">
          <img class="gallery-item-image" src="<?php $_SERVER['DOCUMENT_ROOT'] ?>/img/catalog/items/mosquito-door/5.jpg" alt="">
        </a>
        <!-- /.gallery-item -->
      </div>
      <!-- /.gallery -->
  ...
  <section id="calculation" data-product="mosquitoDoor" data-calculator-type="mosquito-nets">
    <div class="container">
      <div class="section-title">
            ...
            <div class="swiper-slide">
              <div class="calculator-column">
                ...
                <table>
                  ...
                  <tr>
                    <td class="cell-important">Тип сетки</td>
                    <td colspan="2" class="cell-important">Москитная дверь</td>
                  </tr>
                </table>
