<?php
// Мета-теги
$title = 'Москитная сетка "Проведал"';
$description = "";
$keywords = "";
...
<main>
  <div class="container">
    <div class="section-title">
      <h1 class="sub-heading product-heading">Москитная сетка "Проведал"</h1>
    </div>
    <!-- /.section-title -->
    <img class="product-page-image" src="<?php $_SERVER['DOCUMENT_ROOT'] ?>/img/catalog/items/provedal/promo.jpg" alt="">
  </div>
  <!-- /.container -->
  ...
  <section id="product-gallery">
    <div class="container">
      ...
      <div id="lightgallery" class="gallery">
        <a class="gallery-item gallery-item-large" data-fslightbox href="<?php $_SERVER['DOCUMENT_ROOT'] ?>/img/catalog/items/provedal/1.jpg">
          <img class="gallery-item-image" src="<?php $_SERVER['DOCUMENT_ROOT'] ?>/img/catalog/items/provedal/1.jpg" alt="">
        </a>
        <!-- /.gallery-item -->

        <a class="gallery-item gallery-item-large" data-fslightbox href="<?php $_SERVER['DOCUMENT_ROOT'] ?>/img/catalog/items/provedal/2.jpg">
          <img class="gallery-item-image" src="<?php $_SERVER['DOCUMENT_ROOT'] ?>/img/catalog/items/provedal/2.jpg" alt="">
        </a>
        <!-- /.gallery-item -->

        <a class="gallery-item" data-fslightbox href="<?php $_SERVER['DOCUMENT_ROOT'] ?>/img/catalog/items/provedal/3.jpg">
          <img class="gallery-item-image" src="<?php $_SERVER['DOCUMENT_ROOT'] ?>/img/catalog/items/provedal/3.jpg" alt="">
        </a>
        <!-- /.gallery-item -->

        <a class="gallery-item" data-fslightbox href="<?php $_SERVER['DOCUMENT_ROOT'] ?>/img/catalog/items/provedal/4.jpg">
          <img class="gallery-item-image" src="<?php $_SERVER['DOCUMENT_ROOT'] ?>/img/catalog/items/provedal/4.jpg" alt="">
        </a>
        <!-- /.gallery-item -->

        <a class="gallery-item" data-fslightbox href="<?php $_SERVER['DOCUMENT_ROOT'] ?>/img/catalog/items/provedal/5.jpg">
          <img class="gallery-item-image" src="<?php $_SERVER['DOCUMENT_ROOT'] ?>/img/catalog/items/provedal/5.jpg" alt="">
        </a>
        <!-- /.gallery-item -->
      </div>
      <!-- /.gallery -->
  ...
  <section id="calculation" data-product="provedal" data-calculator-type="mosquito-nets">
    <div class="container">
      <div class="section-title">
          ...
          <div class="swiper-wrapper">
            ...
            <div class="swiper-slide">
              <div class="calculator-column">
                ...
                <div class="calculator-description">
                  <h3 class="calculator-title">Доп. информация</h3>
                  <p class="calculator-block calculator-text">Для сборки сдвижной антимоскитной сетки применяется специальный профиль с пазом в который устанавливаются ролики обеспечивающие горизонтальное перемещение сетки.</p>
                  <!-- /.input-wrapper -->
                </div>
