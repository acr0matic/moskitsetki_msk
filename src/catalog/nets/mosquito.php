<?php
// Мета-теги
$title = 'Москитная сетка (Классическая)';
$description = "";
$keywords = "";
...
<main>
  <div class="container">
    <div class="section-title">
      <h1 class="sub-heading product-heading">Москитная сетка (Классическая)</h1>
    </div>
    <!-- /.section-title -->
    <img class="product-page-image" src="<?php $_SERVER['DOCUMENT_ROOT'] ?>/img/catalog/items/mosquito/promo.jpg" alt="">
  </div>
  <!-- /.container -->
  ...
  <section id="product-description">
    <div class="container">
      ...
      <!-- /.section-title -->
      <p class="product-description">Сетка представляет из себя полимерное стекловолокно, ячеистой структуры. Цвет на выбор - белый или коричневый. Незаметна на фоне светового проёма. Устойчива к воздействию солнечного излучения и обладает высокими прочностными характеристиками на
        разрыв и растяжение. Оптимальное соотношение потребительских качеств. Унифицирована для всех рамных систем.
      </p>
    </div>
    <!-- /.container -->
  </section>
  ...
  <section id="product-gallery">
    <div class="container">
      ...
      <div id="lightgallery" class="gallery">
        <a class="gallery-item gallery-item-large" data-fslightbox href="<?php $_SERVER['DOCUMENT_ROOT'] ?>/img/catalog/items/mosquito/1.jpg">
          <img class="gallery-item-image" src="<?php $_SERVER['DOCUMENT_ROOT'] ?>/img/catalog/items/mosquito/1.jpg" alt="">
        </a>
        <!-- /.gallery-item -->

        <a class="gallery-item gallery-item-large" data-fslightbox href="<?php $_SERVER['DOCUMENT_ROOT'] ?>/img/catalog/items/mosquito/2.jpg">
          <img class="gallery-item-image" src="<?php $_SERVER['DOCUMENT_ROOT'] ?>/img/catalog/items/mosquito/2.jpg" alt="">
        </a>
        <!-- /.gallery-item -->
        <a class="gallery-item" data-fslightbox href="<?php $_SERVER['DOCUMENT_ROOT'] ?>/img/catalog/items/mosquito/3.jpg">
          <img class="gallery-item-image" src="<?php $_SERVER['DOCUMENT_ROOT'] ?>/img/catalog/items/mosquito/3.jpg" alt="">
        </a>
        <!-- /.gallery-item -->

        <a class="gallery-item" data-fslightbox href="<?php $_SERVER['DOCUMENT_ROOT'] ?>/img/catalog/items/mosquito/4.jpg">
          <img class="gallery-item-image" src="<?php $_SERVER['DOCUMENT_ROOT'] ?>/img/catalog/items/mosquito/4.jpg" alt="">
        </a>
        <!-- /.gallery-item -->

        <a class="gallery-item" data-fslightbox href="<?php $_SERVER['DOCUMENT_ROOT'] ?>/img/catalog/items/mosquito/5.jpg">
          <img class="gallery-item-image" src="<?php $_SERVER['DOCUMENT_ROOT'] ?>/img/catalog/items/mosquito/5.jpg" alt="">
        </a>
        <!-- /.gallery-item -->
      </div>
      <!-- /.gallery -->
  ...
  <section id="calculation" data-product="mosquito" data-calculator-type="mosquito-nets">
    <div class="container">
      <div class="section-title">
