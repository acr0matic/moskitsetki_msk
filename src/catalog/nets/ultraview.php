<?php
// Мета-теги
$title = 'Москитная сетка "Ультравью"';
$description = "";
$keywords = "";
...
<main>
  <div class="container">
    <div class="section-title">
      <h1 class="sub-heading product-heading">Москитная сетка "Ультравью"</h1>
    </div>
    <!-- /.section-title -->
    <img class="product-page-image" src="<?php $_SERVER['DOCUMENT_ROOT'] ?>/img/catalog/items/ultraview/promo.jpg" alt="">
  </div>
  <!-- /.container -->
  ...
  <section id="product-description">
    <div class="container">
      ...
      <!-- /.section-title -->
      <p class="product-description">Очень тонкие москитные сетки «Ультравью» пропускают максимум воздуха и света и надежно защищают квартиру от неприятных насекомых. Полотно «Ultraview» изготавливается из стекловолокна с бесцветным покрытием: поэтому, несмотря на тонкость, оно очень
        прочно и устойчиво к непогоде.
      </p>
    </div>
    <!-- /.container -->
  </section>
  ...
  <section id="product-gallery">
    <div class="container">
      ...
      <div id="lightgallery" class="gallery">
        <a class="gallery-item gallery-item-large" data-fslightbox href="<?php $_SERVER['DOCUMENT_ROOT'] ?>/img/catalog/items/ultraview/1.jpg">
          <img class="gallery-item-image" src="<?php $_SERVER['DOCUMENT_ROOT'] ?>/img/catalog/items/ultraview/1.jpg" alt="">
        </a>
        <!-- /.gallery-item -->

        <a class="gallery-item gallery-item-large" data-fslightbox href="<?php $_SERVER['DOCUMENT_ROOT'] ?>/img/catalog/items/ultraview/2.jpg">
          <img class="gallery-item-image" src="<?php $_SERVER['DOCUMENT_ROOT'] ?>/img/catalog/items/ultraview/2.jpg" alt="">
        </a>
        <!-- /.gallery-item -->

        <a class="gallery-item" data-fslightbox href="<?php $_SERVER['DOCUMENT_ROOT'] ?>/img/catalog/items/ultraview/3.jpg">
          <img class="gallery-item-image" src="<?php $_SERVER['DOCUMENT_ROOT'] ?>/img/catalog/items/ultraview/3.jpg" alt="">
        </a>
        <!-- /.gallery-item -->

        <a class="gallery-item" data-fslightbox href="<?php $_SERVER['DOCUMENT_ROOT'] ?>/img/catalog/items/ultraview/4.jpg">
          <img class="gallery-item-image" src="<?php $_SERVER['DOCUMENT_ROOT'] ?>/img/catalog/items/ultraview/4.jpg" alt="">
        </a>
        <!-- /.gallery-item -->

        <a class="gallery-item" data-fslightbox href="<?php $_SERVER['DOCUMENT_ROOT'] ?>/img/catalog/items/ultraview/5.jpg">
          <img class="gallery-item-image" src="<?php $_SERVER['DOCUMENT_ROOT'] ?>/img/catalog/items/ultraview/5.jpg" alt="">
        </a>
        <!-- /.gallery-item -->
      </div>
      <!-- /.gallery -->
  ...
  <section id="calculation" data-product="ultraview" data-calculator-type="mosquito-nets">
    <div class="container">
      <div class="section-title">
              ...
              <div class="calculator-column">
                ...
                <div class="calculator-block calculator-inputs input-wrapper">
                  <label class="input-label">
                    <span class="input-info">высота (например, 200см)</span>
                    <input id="calculator-height" class="input input-text input-shadow" type="number" value="50">
                  </label>
                  <label class="input-label">
                    <span class="input-info">ширина (например, 150см)</span>
                    <input id="calculator-width" class="input input-text input-shadow" type="number" value="50">
                  </label>
                </div>
                <!-- /.input-wrapper -->
