<?php
// Мета-теги
$title = 'Москитная сетка "Внутренняя"';
$description = "";
$keywords = "";
...
<main>
  <div class="container">
    <div class="section-title">
      <h1 class="sub-heading product-heading">Москитная сетка "Внутренняя"</h1>
    </div>
    <!-- /.section-title -->
    <img class="product-page-image" src="<?php $_SERVER['DOCUMENT_ROOT'] ?>/img/catalog/items/inner/promo.jpg" alt="">
  </div>
  <!-- /.container -->
  ...
  <section id="product-description">
    <div class="container">
      ...
      <!-- /.section-title -->
      <p class="product-description">Установленная снаружи на окно антимоскитная сетка надежно защищает от любых насекомых и пыли, но далеко не всегда ее можно использовать. В местностях, где летом дуют сильные ветры, ее может сорвать. Упавшая с высоты нескольких этажей пластиковая
        рамка, как правило, ломается и ее опять приходится заказывать. Внутренняя москитная сетка на окно лишена такого недостатка. Ее устанавливают с внутренней стороны окна в проем и крепят специальными зажимами.
      </p>
    </div>
    <!-- /.container -->
  </section>
  ...
  <section id="calculation" data-product="inner" data-calculator-type="mosquito-nets">
    <div class="container">
      <div class="section-title">
          ...
          <div class="swiper-wrapper">
            ...
            <div class="swiper-slide">
              <div class="calculator-column">
                ...
                <div class="calculator-description">
                  <h3 class="calculator-title">Доп. информация</h3>
                  <p class="calculator-block calculator-text">Устанавливаются изнутри помещения. Фиксируются в оконном проёме за счёт конструктивной особенности профиля и плоских пружинных держателей, прикрепляемых к рамке. сетки..</p>
                  <!-- /.input-wrapper -->
                </div>
                <!-- /.calculator-description -->
            ...
            <div class="swiper-slide">
              <div class="calculator-column">
                ...
                <table>
                  ...
                  <tr>
                    <td>Крепеж</td>
                    <td id="table-fasteners-item">Внутренний</td>
